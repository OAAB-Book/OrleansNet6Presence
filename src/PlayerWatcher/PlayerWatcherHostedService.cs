...
public class PlayerWatcherHostedService : IHostedService
{
    ...
    public PlayerWatcherHostedService(ILogger<PlayerWatcherHostedService> logger, IClusterClient client,
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        while (_game == null)
        {
            _logger.LogInformation("Getting current game for player {@PlayerId}...", playerId);
